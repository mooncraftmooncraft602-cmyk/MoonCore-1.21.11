...
/** Charge/sauvegarde les missions et fait progresser les objectifs sur les événements. */
public final class MissionListener implements Listener {
    ...
    public void onMine(BlockBreakEvent e) {
        module.track(e.getPlayer().getUniqueId(), ObjectiveType.MINE_BLOCK, 1);
    }

    @EventHandler(ignoreCancelled = true, priority = EventPriority.MONITOR)
    public void onPlace(BlockPlaceEvent e) {
        module.track(e.getPlayer().getUniqueId(), ObjectiveType.PLACE_BLOCK, 1);
    }
    ...
    public void onKill(EntityDeathEvent e) {
        ...
        ObjectiveType type = (e.getEntity() instanceof Player) ? ObjectiveType.KILL_PLAYER : ObjectiveType.KILL_MOB;
        module.track(killer.getUniqueId(), type, 1);
    }
    ...
    public void onCraft(CraftItemEvent e) {
        if (e.getWhoClicked() instanceof Player p) {
            ...
            module.track(p.getUniqueId(), ObjectiveType.CRAFT_ITEM, Math.max(1, amount));
        }
    }
